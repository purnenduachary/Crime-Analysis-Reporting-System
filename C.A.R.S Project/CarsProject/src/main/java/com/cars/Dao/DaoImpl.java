...
public class DaoImpl implements Dao {
	...
	@Override
	public Map<String, Integer> countIncidentsByStatus() throws SQLException, ClassNotFoundException {
	    Map<String, Integer> statusCountMap = new TreeMap<>();

	    String sql = "select status, count(*) as count from incidents group by status";
	    conn = ConnectionHelper.getConnection();
	    pst = conn.prepareStatement(sql);
	    ResultSet rs = pst.executeQuery();
